...
import com.riwi.pruebaRiwi.controller.interfaces.IUserController;
...
public class UserControllerImpl implements IUserController {
    ...
    public ResponseEntity<AuthUserResponseDto> registerAdmin(@Validated @RequestBody UserRequestDto requestDto) {
        return ResponseEntity.ok(this.userService.register(requestDto, RoleUser.ADMIN));
    }
    ...
    public ResponseEntity<AuthUserResponseDto> registerRegularUser(@Validated @RequestBody UserRequestDto requestDto) {
        return ResponseEntity.ok(this.userService.register(requestDto, RoleUser.CARRIER));
    }
    ...
    @Override
    public ResponseEntity<UserEntity> update(@Validated @RequestBody UserRequestDto requestDto,
